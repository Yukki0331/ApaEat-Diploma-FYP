...
<html class="no-js">
    ...
    <head>
        <title>Restaurant Comment Page</title>
        <!-- Bootstrap -->
            ...
            <div class="row-fluid">
                <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
					   ...
					   <li class="active">
                            <a href="comment.php"><i class="icon-chevron-right"></i>Restaurants Comments</a>
                        </li>
	...
	<?php                                                                          //for printing the  text
						...
						$akl = "DELETE FROM restaurantcomment WHERE id='$_GET[del]' order by id desc";                //query to delete by 'id' which get from while loop
						mysqli_query($db,$akl);
					  
							
					   $i=0;
						$sql = "SELECT * FROM restaurantcomment order by id desc";
        ...
        <td><a class="btn btn-danger" href=comment.php?del='.$id.'><i class="icon-remove icon-white"></i> Delete</a></td>
