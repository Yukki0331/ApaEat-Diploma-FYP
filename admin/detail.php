...
if(isset($_POST['submit']))           //if upload btn is pressed
{
		...
		$rtext = mysqli_real_escape_string($db, $_POST['rtext']);
		$ing = mysqli_real_escape_string($db, $_POST['ing']);
	    ...
	    $image =$row['image'];
		 $title =$row['title'];
		  ...
		  $disc =$row['disc'];
						          ...
						          echo	'   <td><a class="btn" href="editdetailrecipy.php?rid='.$row["rid"].'&title='.$row["title"].'&title_text='.$row["title_text"].'&ing_text='.$row["ing_text"].'&disc='.$row["disc"].'&id='.$row["id"].'&image='.$row["image"].'  ">Edit</a></td>';
									echo	'   <td><a class="btn btn-danger" href=detail.php?id='.$row['rid'].'  style="color: red;"><i class="icon-remove icon-red"></i> Delete</a></td>';
