...
if(isset($_POST['ssubmitt'])){  

$id= mysqli_real_escape_string($mysqli, $_POST['id']);
$title = mysqli_real_escape_string($mysqli, $_POST['title']);
$rtext = mysqli_real_escape_string($mysqli, $_POST['rtext']);
$ing = mysqli_real_escape_string($mysqli, $_POST['ing']);
					...
					{        
									if($fsize>=1000000)
									...
									else
										{
										  ...
										  $sql = "UPDATE full_recipy SET title='$title', title_text='$rtext', image='$fnew', ing_text='$ing', disc='$disc', rid='$rid' WHERE id='$id'";
...
.search_wrap.search_wrap_1 .search_box .input{
    ...
    <head>
        <title>Admin  Detail Recipe Page</title>
        <!-- Bootstrap -->
            ...
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <div class="nav-collapse collapse">
						...
						<center><form action="searchdetail.php" method="GET">
							
		<div class="search_wrap search_wrap_1">
			<div class="search_box">
				<input type="text" class="input" required value="<?php if(isset($_GET['search'])){echo $_GET['search']; } ?>" name="search"  placeholder="search detail">
				<button class="button">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Edit Detail Recipe</div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
                                    ...
                                    <form class="form-horizontal" action='' method='post'  enctype="multipart/form-data">
                                      <fieldset>
                                        <legend>EDIT Detail Recipes  </legend>
										
											 <div class="control-group">
                                          <label class="control-label" for="typeahead">Recipe ID(important) </label>
                                          <div class="controls">
										  
                                            <input type="text" class="span6" name='rid' id="typeahead" value="<?php echo $_GET['rid'] ?> " data-provide="typeahead" data-items="4" data-source='["Alabama","Alaska","Arizona","Arkansas","California","Colorado","Connecticut","Delaware","Florida","Georgia","Hawaii","Idaho","Illinois","Indiana","Iowa","Kansas","Kentucky","Louisiana","Maine","Maryland","Massachusetts","Michigan","Minnesota","Mississippi","Missouri","Montana","Nebraska","Nevada","New Hampshire","New Jersey","New Mexico","New York","North Dakota","North Carolina","Ohio","Oklahoma","Oregon","Pennsylvania","Rhode Island","South Carolina","South Dakota","Tennessee","Texas","Utah","Vermont","Virginia","Washington","West Virginia","Wisconsin","Wyoming"]'>
                                          </br>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            ...
                                            <input type="text" class="span6" name='title' value="<?php echo $_GET['title'] ?> " id="typeahead"  />
										 ...
										 <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <textarea class="input-xlarge textarea"  name='rtext' placeholder="<?php print $_GET['title_text'] ?> " style="width: 810px; height: 200px"></textarea>
                                          </div>
                                        </div>
									 ...
									 <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <textarea class="input-xlarge textarea"  name='ing' placeholder="<?php echo $_GET['ing_text'] ?> " style="width: 810px; height: 200px"></textarea>
                                          </div>
                                        </div>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <textarea class="input-xlarge textarea"  name='disc' placeholder="<?php echo $_GET['disc'] ?> " style="width: 810px; height: 200px"></textarea>
                                          </div>
                                        </div>
		                      
							  <div class="control-group">
                                          <label class="control-label" for="typeahead">Detail Recipe ID </label>
                                          <div class="controls">
										  
                                            <input type="text" class="span6" name='id'  value="<?php echo $_GET['id'] ?> " id="typeahead"  />
                                        ...
                                        <div class="form-actions">
                                         <input type='submit' name='ssubmitt' value='Update' class="btn btn-primary"/>
