...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  ...
	  <div class="mainbox" id="mainbox">
	      <div class="box" id="box">
               <div class="box1">
			       <span class="font span1"><h5>Pan Mee</h5></span>
				   <span class="font span2"><h5>Fried Rice</h5></span>
				   <span class="font span3"><h5>Sweet & Sour Chicken</h5></span>
				   <span class="font span4"><h5>Hakka Mee</h5></span>
				   <span class="font span5"><h5>Char Siu Rice</h5></span>
			   </div>
               <div class="box2">
                   <span class="font span1"><h5>Wonton Mee</h5></span>
                   <span class="font span2"><h5>Kung Pao Chicken</h5></span>			   
                   <span class="font span3"><h5>Chicken Rice</h5></span>			   
                   <span class="font span4"><h5>Hotpot</h5></span>			   
                   <span class="font span5"><h5>Dim Sum</h5></span>			   
			   </div> 
		  </div>
	  ...
	  <script src="js/cwheel.js"></script>
