		...
		<div class="flex pt-5 md:pt-12 justify-center">
			...
			<div class="bg-white md:h-96 w-11/12 md:w-7/10 md:mx-8 md:flex md:max-w-5xl shadow-lg rounded-lg">
				...
				<div class="mb-4 pt-5 px-6 max-w-xl md:max-w-5xl md:w-1/2" style="overflow: scroll">
					...
					<span id="dish-page-cuisine-type" class="bg-yellow-400 text-gray-50 text-sm font-light rounded-md px-2 py-1">Halal</span>
					<br><br>
					<center>
					<span class="vzATR"> 
					<i class="fa-solid fa-computer" style=" color: #F94001;"></i> </span>
					<a class="BPsyj" href="https://marriottbonvoyasia.com/restaurants-bars/Putrajaya-Marriott-Hotel-Zest-Lifestyle-Restaurant">Website</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<i class="fa-solid fa-phone" style=" color: #F94001;"></i> </span>
					<span class="BPsyj">+603- 89498888</span>
					</center>
					<br>
				   ...
				   <i class="fa-solid fa-utensils" style=" color: #F94001;"></i>
					...
					The food quality and variety is excellent. The staff is very pleasant and helpful. Breakfast has Asian, Malaysian and western food. Juices, teas, and variety of coffee is offered.
					</P>
				</div>
			</div>
		</div> 
		...
		<div class="py-5 flex justify-center">
			<div class="bg-white w-11/12 md:w-7/10 md:mx-8 md:flex md:max-w-5xl shadow-lg rounded-lg">
				<div class="pt-5 px-6 max-w-xl lg:max-w-5xl mb-4">
					...
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3984.460488346766!2d101.7038889144252!3d2.969642897837195!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31cdb5f6074b8a15%3A0xc68adb35685dd95!2sZest%20Restaurant!5e0!3m2!1sen!2smy!4v1669648013354!5m2!1sen!2smy" width="970" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
						</P></center>
...
{   
	             ...
	             $sql = "INSERT INTO restaurantcomment(text, restaurantId) VALUES ('$text', '20')";
	             mysqli_query($db, $sql);
...
<?php                                                                          //for printing the  text
    ...
    $sql = "SELECT * FROM restaurantcomment WHERE restaurantId='20'";
	 $result = mysqli_query($db, $sql);
