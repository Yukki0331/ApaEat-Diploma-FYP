		...
		<div class="flex pt-5 md:pt-12 justify-center">
			...
			<div class="bg-white md:h-96 w-11/12 md:w-7/10 md:mx-8 md:flex md:max-w-5xl shadow-lg rounded-lg">
				...
				<div class="mb-4 pt-5 px-6 max-w-xl md:max-w-5xl md:w-1/2" style="overflow: scroll">
					...
					<span id="dish-page-cuisine-type" class="bg-yellow-400 text-gray-50 text-sm font-light rounded-md px-2 py-1">Mexico</span>
					<br><br>
					<center>
					<span class="vzATR"> 
					<i class="fa-solid fa-computer" style=" color: #F94001;"></i> </span>
					<a class="BPsyj" href="https://suasanasuites.com.my/jb/dining/">Website</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<i class="fa-solid fa-phone" style=" color: #F94001;"></i> </span>
					<span class="BPsyj">+6017- 2670148</span>
					</center>
					<br>
				   ...
				   <i class="fa-solid fa-utensils" style=" color: #F94001;"></i>
					...
					The HIGHEST CAFÉ - The stunning view of the Straits of Johor just makes dining at Suasana Suites Cafe, Level 33A an unforgettable experience. The gift of hospitality at Suasana All Suites Hotel is to provide a warm welcome, nostalgic Johor and Malaysian food with a twist and a luxurious stay.
					</P>
				</div>
			</div>
		</div> 
		...
		<div class="py-5 flex justify-center">
			<div class="bg-white w-11/12 md:w-7/10 md:mx-8 md:flex md:max-w-5xl shadow-lg rounded-lg">
				<div class="pt-5 px-6 max-w-xl lg:max-w-5xl mb-4">
					...
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3988.5171302051667!2d103.75947801475418!3d1.4633332989328027!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31da12c49cc27ecb%3A0x8a3397ebd25bffc!2sSuasana%20All%20Suites%20Hotel%20Johor%20Bahru!5e0!3m2!1sen!2smy!4v1669688604247!5m2!1sen!2smy" width="970" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
					</P></center>
...
{   
	             ...
	             $sql = "INSERT INTO restaurantcomment(text, restaurantId) VALUES ('$text', '33')";
	             mysqli_query($db, $sql);
...
<?php                                                                          //for printing the  text
    ...
    $sql = "SELECT * FROM restaurantcomment WHERE restaurantId='33'";
	 $result = mysqli_query($db, $sql);
