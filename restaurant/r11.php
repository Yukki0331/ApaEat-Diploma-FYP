		...
		<div class="flex pt-5 md:pt-12 justify-center">
			...
			<div class="bg-white md:h-96 w-11/12 md:w-7/10 md:mx-8 md:flex md:max-w-5xl shadow-lg rounded-lg">
				...
				<div class="mb-4 pt-5 px-6 max-w-xl md:max-w-5xl md:w-1/2" style="overflow: scroll">
					...
					<a class="BPsyj" href="http://www.facebook.com">Website</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<i class="fa-solid fa-phone" style=" color: #F94001;"></i> </span>
					<span class="BPsyj">+6019- 5444738</span>
					</center>
					<br>
				   ...
				   <i class="fa-solid fa-utensils" style=" color: #F94001;"></i>
					...
					ABOUT
					 ...
					 <p id="dish-page-direction-text" class="mt-4 font-regular text-base">
					  The old style of using banana leaf as a plate and piling up your food as you go along eating. The menu is mainly Indian cuisine. And when i say pack, i mean you can put as much food on your banana leaf plate and the place is usually pack with people. So, do come here if you’re in the mood for this type of food.
		...
		<div class="py-5 flex justify-center">
			<div class="bg-white w-11/12 md:w-7/10 md:mx-8 md:flex md:max-w-5xl shadow-lg rounded-lg">
				<div class="pt-5 px-6 max-w-xl lg:max-w-5xl mb-4">
					...
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3985.2999060092457!2d101.93685861475629!3d2.7270624980133213!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31cddd8f1552e1e5%3A0x5b13a450af05a63a!2sNumber%20One%20Top%20Curry%20House!5e0!3m2!1sen!2smy!4v1669570747446!5m2!1sen!2smy" width="970" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>	
						</P></center>
...
{   
	             ...
	             $sql = "INSERT INTO restaurantcomment(text, restaurantId) VALUES ('$text', '11')";
	             mysqli_query($db, $sql);
...
<?php                                                                          //for printing the  text
    ...
    $sql = "SELECT * FROM restaurantcomment WHERE restaurantId='11'";
	 $result = mysqli_query($db, $sql);
