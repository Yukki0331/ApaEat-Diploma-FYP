		...
		<div class="flex pt-5 md:pt-12 justify-center">
			...
			<div class="bg-white md:h-96 w-11/12 md:w-7/10 md:mx-8 md:flex md:max-w-5xl shadow-lg rounded-lg">
				...
				<div class="mb-4 pt-5 px-6 max-w-xl md:max-w-5xl md:w-1/2" style="overflow: scroll">
					...
					<span id="dish-page-cuisine-type" class="bg-yellow-400 text-gray-50 text-sm font-light rounded-md px-2 py-1">Malay Vegan</span>
					<br><br>
					<center>
					<span class="vzATR"> 
					<i class="fa-solid fa-computer" style=" color: #F94001;"></i> </span>
					<a class="BPsyj" href="https://www.facebook.com/people/Vegan-Recipe-Cafe/100066746861551/">Website</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<i class="fa-solid fa-phone" style=" color: #F94001;"></i> </span>
					<span class="BPsyj">+6012- 9222332</span>
					</center>
					<br>
		...
		<div class="py-5 flex justify-center">
			<div class="bg-white w-11/12 md:w-7/10 md:mx-8 md:flex md:max-w-5xl shadow-lg rounded-lg">
				<div class="pt-5 px-6 max-w-xl lg:max-w-5xl mb-4">
					...
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3972.5446549818366!2d103.13067351443428!3d5.333473396131083!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31b7be7f266cbe83%3A0x1145cd78fa3baa25!2sKafe%20Vegan%20Recipe!5e0!3m2!1sen!2smy!4v1669630022034!5m2!1sen!2smy" width="970" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>	
						</P></center>
...
{   
	             ...
	             $sql = "INSERT INTO restaurantcomment(text, restaurantId) VALUES ('$text', '18')";
	             mysqli_query($db, $sql);
...
<?php                                                                          //for printing the  text
    ...
    $sql = "SELECT * FROM restaurantcomment WHERE restaurantId='18'";
	 $result = mysqli_query($db, $sql);
