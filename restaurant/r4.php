		...
		<div class="flex pt-5 md:pt-12 justify-center">
			...
			<div class="bg-white md:h-96 w-11/12 md:w-7/10 md:mx-8 md:flex md:max-w-5xl shadow-lg rounded-lg">
				...
				<div class="mb-4 pt-5 px-6 max-w-xl md:max-w-5xl md:w-1/2" style="overflow: scroll">
					...
					<span id="dish-page-cuisine-type" class="bg-yellow-400 text-gray-50 text-sm font-light rounded-md px-2 py-1">Australian & Japanese </span>
					<br><br>
					<center>
					<span class="vzATR"> 
					<i class="fa-solid fa-computer" style=" color: #F94001;"></i> </span>
					<a class="BPsyj" href="https://www.marriott.com/en-us/hotels/kulmd-le-meridien-kuala-lumpur/dining/">Website</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<i class="fa-solid fa-phone" style=" color: #F94001;"></i> </span>
					<span class="BPsyj">+603- 22637434</span>
					</center>
					<br>
		...
		<div class="py-5 flex justify-center">
			<div class="bg-white w-11/12 md:w-7/10 md:mx-8 md:flex md:max-w-5xl shadow-lg rounded-lg">
				<div class="pt-5 px-6 max-w-xl lg:max-w-5xl mb-4">
					...
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3983.8450981407386!2d101.68409821442572!3d3.1355923977168203!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31cc49c05464fca5%3A0x8f55a48d79427608!2sPRIME%20%2C%20Le%20M%C3%A9ridien%20Kuala%20Lumpur!5e0!3m2!1sen!2smy!4v1669473745698!5m2!1sen!2smy" width="970" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>	
						</P></center>
...
{   
	             ...
	             $sql = "INSERT INTO restaurantcomment(text, restaurantId) VALUES ('$text', '4')";
	             mysqli_query($db, $sql);
...
<?php                                                                          //for printing the  text
    ...
    $sql = "SELECT * FROM restaurantcomment WHERE restaurantId='4'";
	 $result = mysqli_query($db, $sql);
