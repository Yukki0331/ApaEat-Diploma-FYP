	...
	<!-- video section -->
				...
				<div class="flex flex-row mt-8">
					...
					<div class="w-8/12 md:w-10/12 ml-2">
						...
						<p id="dish-page-owner-caption" class="text-sm font-light text-gray-600 truncate overflow-ellipsis">Per Serving: 142 calories; fat 20.5g; saturated fat 3.5g; mono fat 1.3g; poly fat 2.1g; protein 31.4g; carbohydrates 40.6g; fiber 9g; cholesterol 99mg; iron 2.1mg; sodium 641mg; calcium 293mg.</p>
					</div>
				</div>
...
{   
	             ...
	             $sql = "INSERT INTO commentbar(text, recipy_id) VALUES ('$text', '24')";
	             mysqli_query($db, $sql);
...
<?php                                                                          //for printing the  text
    ...
    $sql = "SELECT * FROM commentbar WHERE recipy_id='24'";
	 $result = mysqli_query($db, $sql);
