...
?>
            ...
            <div class="content">
				...
				<br>
			<span class="fas fa-clock" style="font-size: 18px; margin-top: 1.5em; ">&nbsp;&nbsp;13 Minutes</span>
			<br>
            <a href="poR1.php" class="btn" style="align:right;">show recipe</a>
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px; margin-top: 2.5em;  ">&nbsp;&nbsp;100 Minutes</span>
				<br>
            <a href="poR4.php" class="btn">show recipe</a>
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px;  margin-top: 5em;  ">&nbsp;&nbsp;10 Minutes</span>
				<br>
    ...
    $sql = "SELECT * FROM full_recipy where id='47'";
	 $result = mysqli_query($db, $sql);
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px;  margin-top: 2.3em;  ">&nbsp;&nbsp;50 Minutes</span>
				<br>
            <a href="B4.php" class="btn">show recipe</a>
            </div>
        </div>
