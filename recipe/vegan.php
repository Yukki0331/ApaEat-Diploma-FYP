...
?>
            ...
            <div class="content">
				...
				<br>
			<span class="fas fa-clock" style="font-size: 18px; margin-top: 0.45em; ">&nbsp;&nbsp;100 Minutes</span>
			<br>
            <a href="V1.php" class="btn" style="align:right;">show recipe</a>
    ...
    $sql = "SELECT * FROM full_recipy where id='34'";
	 $result = mysqli_query($db, $sql);
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px; margin-top: 1.4em;">&nbsp;&nbsp;60 Minutes</span>
				<br>
            <a href="V2.php" class="btn">show recipe</a>
    ...
    $sql = "SELECT * FROM full_recipy where id='35'";
	 $result = mysqli_query($db, $sql);
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px; ">&nbsp;&nbsp;250 Minutes</span>
				<br>
            <a href="V3.php" class="btn">show recipe</a>
            </div>
        </div>
    ...
    $sql = "SELECT * FROM full_recipy where id='36'";
	 $result = mysqli_query($db, $sql);
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px; margin-top: 2.8em;">&nbsp;&nbsp;45 Minutes</span>
				<br>
            <a href="V4.php" class="btn">show recipe</a>
            </div>
        </div>
    ...
    $sql = "SELECT * FROM full_recipy where id='37'";
	 $result = mysqli_query($db, $sql);
...
?>
            ...
            <div class="content">
               ...
               <h3 style="font-size: 22px; "><?php echo $title.$row1['title']; ?></h3>
				...
				<br>
            <a href="V5.php" class="btn">show recipe</a>
            </div>
        </div>
    ...
    $sql = "SELECT * FROM full_recipy where id='38'";
	 $result = mysqli_query($db, $sql);
...
?>
            ...
            <div class="content">
               ...
               <h3 style="font-size: 22px; "><?php echo $title.$row1['title']; ?></h3>
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px; margin-top: 2.6em; ">&nbsp;&nbsp;330 Minutes</span>
				<br>
            <a href="V6.php" class="btn">show recipe</a>
            </div>
        </div>
    ...
    $sql = "SELECT * FROM full_recipy where id='39'";
	 $result = mysqli_query($db, $sql);
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px;  margin-top: 2.6em; ">&nbsp;&nbsp;110 Minutes</span>
				<br>
            <a href="V7.php" class="btn">show recipe</a>
            </div>
        </div>
    ...
    $sql = "SELECT * FROM full_recipy where id='40'";
	 $result = mysqli_query($db, $sql);
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px; margin-top: 2.6em; ">&nbsp;&nbsp;25 Minutes</span>
				<br>
            <a href="V8.php" class="btn">show recipe</a>
            </div>
        </div>
