...
<section class="menu" id="menu">
    ...
    $sql = "SELECT * FROM full_recipy where id='52'";
...
?>
            ...
            <div class="content">
				...
				<br>
			<span class="fas fa-clock" style="font-size: 18px; margin-top: 1.5em; ">&nbsp;&nbsp;30 Minutes</span>
			<br>
            <a href="A1.php" class="btn" style="align:right;">show recipe</a>
    ...
    $sql = "SELECT * FROM full_recipy where id='53'";
	 $result = mysqli_query($db, $sql);
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px; margin-top: 3.75em; ">&nbsp;&nbsp;35 Minutes</span>
				<br>
            <a href="A2.php" class="btn">show recipe</a>
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px;  margin-top: 1.2em; ">&nbsp;&nbsp;60 Minutes</span>
				<br>
            <a href="menu2.php" class="btn">show recipe</a>
            </div>
        </div>
    ...
    $sql = "SELECT * FROM full_recipy where id='54'";
	 $result = mysqli_query($db, $sql);
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px;  margin-top: 2.6em; ">&nbsp;&nbsp;40 Minutes</span>
				<br>
            <a href="A4.php" class="btn">show recipe</a>
            </div>
        </div>
...
<section class="footer">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <a href="https://goo.gl/maps/9yPngvtT1GUxQmK19" class="links" target="blank"> <i class="fas fa-map-marker-alt"></i> Subang, Malaysia - 47000 </a>
        </div>
