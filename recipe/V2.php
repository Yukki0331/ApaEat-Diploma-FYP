		...
		<div class="flex pt-5 md:pt-12 justify-center">
			<div class="bg-white md:h-96 w-11/12 md:w-7/10 md:mx-8 md:flex md:max-w-5xl shadow-lg rounded-lg">
				...
				<div class="mb-4 pt-5 px-6 max-w-xl md:max-w-5xl md:w-1/2" style="overflow: scroll">
					...
					<span id="dish-page-prep-time" class="bg-yellow-400 text-gray-50 text-sm font-light rounded-md px-2 py-1">60 min</span>
	...
	<!-- video section -->
				...
				<div class="flex flex-row mt-8">
					...
					<div class="w-8/12 md:w-10/12 ml-2">
						...
						<p id="dish-page-owner-caption" class="text-sm font-light text-gray-600 truncate overflow-ellipsis">Per Serving: 242 calories; fat 41.5g; saturated fat 1.1g; mono fat 1.3g; poly fat 1.1g; protein 9.4g; carbohydrates 90.6g; fiber 9g; cholesterol 99mg; iron 11mg; sodium 418mg; calcium 213mg.</p>
					</div>
				</div>
...
{   
	             ...
	             $sql = "INSERT INTO commentbar(text, recipy_id) VALUES ('$text', '9')";
	             mysqli_query($db, $sql);
...
<?php                                                                          //for printing the  text
    ...
    $sql = "SELECT * FROM commentbar WHERE recipy_id='9'";
	 $result = mysqli_query($db, $sql);
