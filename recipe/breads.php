...
<section class="menu" id="menu">
    ...
    $sql = "SELECT * FROM full_recipy where id='67'";
...
?>
            ...
            <div class="content">
				...
				<br>
			<span class="fas fa-clock" style="font-size: 18px;  margin-top: 4.5em; ">&nbsp;&nbsp;100 Minutes</span>
			<br>
            <a href="bread1.php" class="btn" style="align:right;">show recipe</a>
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px; margin-top: 1.5em;  ">&nbsp;&nbsp;110 Minutes</span>
				<br>
            <a href="bread2.php" class="btn">show recipe</a>
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px;  margin-top: 4.1em;  ">&nbsp;&nbsp;45 Minutes</span>
				<br>
            <a href="bread3.php" class="btn">show recipe</a>
            </div>
        </div>
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px;  margin-top: 2.45em;  ">&nbsp;&nbsp;100 Minutes</span>
				<br>
            <a href="bread4.php" class="btn">show recipe</a>
            </div>
        </div>
