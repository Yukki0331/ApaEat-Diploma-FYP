...
?>
            ...
            <div class="content">
				...
				<br>
			<span class="fas fa-clock" style="font-size: 18px; margin-top: 1.5em; ">&nbsp;&nbsp;100 Minutes</span>
			<br>
            <a href="r3.php" class="btn" style="align:right;">show recipe</a>
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px; margin-top: 2.5em;  ">&nbsp;&nbsp;120 Minutes</span>
				<br>
            <a href="menu1.php" class="btn">show recipe</a>
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px;  margin-top: 3.7em;  ">&nbsp;&nbsp;45 Minutes</span>
				<br>
            <a href="L3.php" class="btn">show recipe</a>
            </div>
        </div>
    ...
    $sql = "SELECT * FROM full_recipy where id='49'";
	 $result = mysqli_query($db, $sql);
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px;  margin-top: 2.3em;  ">&nbsp;&nbsp;60 Minutes</span>
				<br>
            <a href="L4.php" class="btn">show recipe</a>
            </div>
        </div>
