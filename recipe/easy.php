...
<section class="menu" id="menu">
    ...
    <h1 class="heading"> Quick & Easy </h1>
...
?>
            ...
            <div class="content">
				...
				<br>
			<span class="fas fa-clock" style="font-size: 18px;  margin-top: 1.75em; ">&nbsp;&nbsp;45 Minutes</span>
			<br>
            <a href="E1.php" class="btn" style="align:right;">show recipe</a>
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px; margin-top: 2.6em;  ">&nbsp;&nbsp;60 Minutes</span>
				<br>
            <a href="poR6.php" class="btn">show recipe</a>
...
?>
            ...
            <div class="content">
				...
				<span class="fas fa-clock" style="font-size: 18px;  margin-top: 2.6em;  ">&nbsp;&nbsp;60 Minutes</span>
				<br>
            <a href="menu3.php" class="btn">show recipe</a>
            </div>
        </div>
