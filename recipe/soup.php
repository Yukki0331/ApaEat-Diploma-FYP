...
?>
            ...
            <div class="content">
				...
				<br>
			<span class="fas fa-clock" style="font-size: 18px; margin-top: 4.2em; ">&nbsp;&nbsp;110 Minutes</span>
			<br>
            <a href="S1.php" class="btn" style="align:right;">show recipe</a>
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px; margin-top: 3.8em;  ">&nbsp;&nbsp;200 Minutes</span>
				<br>
            <a href="S2.php" class="btn">show recipe</a>
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px;  margin-top: 2.3em;">&nbsp;&nbsp;30 Minutes</span>
				<br>
            <a href="S3.php" class="btn">show recipe</a>
            </div>
        </div>
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px;  margin-top: 2.3em; ">&nbsp;&nbsp;45 Minutes</span>
				<br>
            <a href="S4.php" class="btn">show recipe</a>
            </div>
        </div>
