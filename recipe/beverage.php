...
?>
			...
			<br>
            <a href="W1.php" class="btn" style="align:right;">show recipe</a>
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px; margin-top: 1.5em;">&nbsp;&nbsp;10 Minutes</span>
				<br>
            <a href="W2.php" class="btn">show recipe</a>
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px;  margin-top: 2.8em; ">&nbsp;&nbsp;30 Minutes</span>
				<br>
            <a href="menu7.php" class="btn">show recipe</a>
            </div>
        </div>
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px;  margin-top: 4.3em;  ">&nbsp;&nbsp;10 Minutes</span>
				<br>
            <a href="B3.php" class="btn">show recipe</a>
            </div>
        </div>
