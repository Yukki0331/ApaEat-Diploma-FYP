...
<section class="menu" id="menu">
    ...
    $sql = "SELECT * FROM full_recipy where id='61'";
...
?>
            ...
            <div class="content">
				...
				<br>
			<span class="fas fa-clock" style="font-size: 18px;  margin-top: 1.75em; ">&nbsp;&nbsp;30 Minutes</span>
			<br>
            <a href="H1.php" class="btn" style="align:right;">show recipe</a>
    ...
    $sql = "SELECT * FROM full_recipy where id='62'";
	 $result = mysqli_query($db, $sql);
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px; margin-top: 2.85em;  ">&nbsp;&nbsp;15 Minutes</span>
				<br>
            <a href="H2.php" class="btn">show recipe</a>
    ...
    $sql = "SELECT * FROM full_recipy where id='63'";
	 $result = mysqli_query($db, $sql);
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px;  margin-top: 2.8em;  ">&nbsp;&nbsp;40 Minutes</span>
				<br>
            <a href="H3.php" class="btn">show recipe</a>
            </div>
        </div>
    ...
    $sql = "SELECT * FROM full_recipy where id='64'";
	 $result = mysqli_query($db, $sql);
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px;  margin-top: 2.8em;  ">&nbsp;&nbsp;250 Minutes</span>
				<br>
            <a href="H4.php" class="btn">show recipe</a>
            </div>
        </div>
