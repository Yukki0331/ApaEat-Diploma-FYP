...
?>
            ...
            <div class="content">
				...
				<br>
			<span class="fas fa-clock" style="font-size: 18px; margin-top: 0.45em; ">&nbsp;&nbsp;70 Minutes</span>
			<br>
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px; margin-top: 4.1em;  ">&nbsp;&nbsp;90 Minutes</span>
				<br>
            <a href="D2.php" class="btn">show recipe</a>
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px;  margin-top: 1.3em;  ">&nbsp;&nbsp;15 Minutes</span>
				<br>
            <a href="D3.php" class="btn">show recipe</a>
            </div>
        </div>
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px;  margin-top: 2.75em; ">&nbsp;&nbsp;220 Minutes</span>
				<br>
            <a href="D4.php" class="btn">show recipe</a>
            </div>
        </div>
