...
?>
            ...
            <div class="content">
				...
				<br>
			<span class="fas fa-clock" style="font-size: 18px;  margin-top: 1.75em; ">&nbsp;&nbsp;15 Minutes</span>
			<br>
			<a href="poR8.php" class="btn" style="align:right;">show recipe</a>
    ...
    $sql = "SELECT * FROM full_recipy where id='59'";
	 $result = mysqli_query($db, $sql);
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px; margin-top: 4.05em; ">&nbsp;&nbsp;50 Minutes</span>
				<br>
            <a href="appe1.php" class="btn">show recipe</a>
    ...
    $sql = "SELECT * FROM full_recipy where id='60'";
	 $result = mysqli_query($db, $sql);
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px;  margin-top: 3.5em;  ">&nbsp;&nbsp;20 Minutes</span>
				<br>
            <a href="appe2.php" class="btn">show recipe</a>
            </div>
        </div>
    ...
    $sql = "SELECT * FROM full_recipy where id='58'";
	 $result = mysqli_query($db, $sql);
...
?>
            ...
            <div class="content">
                ...
                <p><?php echo $disc.$row1['disc']; ?></p>
				<br>
				<span class="fas fa-clock" style="font-size: 18px;  margin-top: 3.9em; ">&nbsp;&nbsp;330 Minutes</span>
				<br>
            <a href="E4.php" class="btn">show recipe</a>
            </div>
        </div>
